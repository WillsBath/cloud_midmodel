# ============================================================
# Lamport's Logical Clock - Client-Server Communication
# ============================================================
# AIM:
# To implement Lamport's Logical Clock algorithm using a simple
# client-server communication model in Python.
#
# PROCEDURE TO EXECUTE:
# ------------------------------------------------------------
# 1. Save this file as "lamport_clock.py"
# 2. Open TWO terminals:
#       Terminal 1 → Run the server:
#           python lamport_clock.py server
#       Terminal 2 → Run the client:
#           python lamport_clock.py client
# 3. The client sends messages with its logical clock timestamp.
# 4. The server updates its own logical clock using Lamport’s rule:
#           clock = max(local_clock, received_clock) + 1
# 5. Both display their clock values after each message exchange.
# ------------------------------------------------------------

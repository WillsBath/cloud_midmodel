# ============================================================
# VECTOR CLOCK IMPLEMENTATION (Client-Server Model)
# ============================================================
# AIM:
# To implement Vector Clocks for maintaining causality among distributed processes.
#
# PROCEDURE TO EXECUTE:
# ------------------------------------------------------------
# 1. Save this file as "vector_clock.py"
#
# 2. Open TWO terminals:
#       Terminal 1 → Run the server:
#           python vector_clock.py server
#
#       Terminal 2 → Run the client:
#           python vector_clock.py client
#
# 3. Each process (client and server) maintains a vector clock [C, S]
#       - Client = index 0
#       - Server = index 1
#
# 4. When a message is sent, the sender increments its own clock entry,
#    attaches the full vector, and sends it.
#
# 5. Upon receiving, the receiver:
#       - Takes elementwise max of its vector and received vector.
#       - Increments its own entry by 1.
#
# 6. Type messages in the client terminal; the server will respond with
#    updated vector clocks to show causality.
# ------------------------------------------------------------
